...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Registration Unsuccessful</strong></div>
        </div>
      </div>
    </div>  
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <h2 class="display-3 text-black">Oops! Your Registration Was Unsuccessful! </h2>
            <p class="lead mb-5">Username and Password Already Taken!</p>
            <p><a href="register.php" class="btn btn-sm height-auto px-4 py-3 btn-primary">Register Again</a></p>
          </div>
        </div>
      </div>
    </div>
