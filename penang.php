...
<body>
    ...
    <div class="site-wrap">
        ...
        <div class="bg-light py-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a href="trips.php">Shop</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Penang</strong></div>
                </div>
            </div>
        </div>
        ...
        <div class="site-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h2 class="text-black">Penang</h2>
                        <p>The best state to live in.</p>
                        <p class="mb-4">Lots of delicious hawker food</p>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-7 site-section-heading text-center pt-4">
                        <h2>Available Buses Heading to Penang</h2>
                    </div>
                </div>
                <div class="row">
