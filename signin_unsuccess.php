...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Sign In Unsuccessful</strong></div>
        </div>
      </div>
    </div>  
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <h2 class="display-3 text-black">Oops! Your Email Or Password Was Wrong</h2>
            <p class="lead mb-5">Reenter Email and Password Correctly!</p>
            <p><a href="signin.php" class="btn btn-sm height-auto px-4 py-3 btn-primary">Back to Sign In</a></p>
          </div>
        </div>
      </div>
    </div>
