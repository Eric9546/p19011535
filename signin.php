...
<body>
    ...
    <div class="site-wrap">
        ...
        <div class="custom-border-bottom py-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Sign In</strong></div>
                </div>
            </div>
        </div>
        ...
        <div class="site-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="h3 mb-3 text-black">Sign In To Start Booking!</h2>
                    </div>
                    <div class="col-md-7">

                        <form action="signin_authenticate.php" method="post">
                            ...
                            <div class="p-3 p-lg-5 border">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="password" class="form-control" id="pass" name="password" placeholder="Must Contain 8 Or More Characters!" required>
                                    </div>
                                </div>
