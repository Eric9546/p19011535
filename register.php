...
<html lang="en">
<head>
    <title>ShopMax &mdash; A Travel Bus Company</title>
    <meta charset="utf-8">
    ...
    <div class="site-wrap">
        ...
        <div class="site-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="h3 mb-3 text-black">Register To Become A Customer!</h2>
                    </div>
                    <div class="col-md-7">

                        <form action="register_authenticate.php" method="post">
                            ...
                            <div class="p-3 p-lg-5 border">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="password" class="form-control" id="pass" name="password" minlength="8" placeholder="Must Contain 8 Or More Characters!" required>
                                    </div>
                                </div>
