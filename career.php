...
<body>
    ...
    <div class="site-wrap">
        ...
        <div class="custom-border-bottom py-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Career</strong></div>
                </div>
            </div>
        </div>
        ...
        <div class="site-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="h3 mb-3 text-black">Submit Your Resume Here!</h2>
                    </div>
                    <div class="col-md-7">

                        <form action="career_execute.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="p-3 p-lg-5 border">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <input type="submit" class="btn btn-primary btn-lg btn-block" value="Send Resume">
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="col-md-5 ml-auto">
                        <div class="p-4 border mb-3">
                            <span class="d-block text-primary h6 text-uppercase">Mechanic</span>
                            <p class="mb-0">Repair and maintain our fleet of buses</p>
                        </div>
                        <div class="p-4 border mb-3">
                            <span class="d-block text-primary h6 text-uppercase">Clerk</span>
                            <p class="mb-0">Record the daily earnings and produce reports</p>
                        </div>
                        <div class="p-4 border mb-3">
                            <span class="d-block text-primary h6 text-uppercase">Manager</span>
                            <p class="mb-0">Handle the workers at one of our branches</p>
                        </div>
